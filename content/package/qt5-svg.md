...
reverse_depends = "['firetools', 'flightgear', 'keepassxc', 'kiconthemes5', 'kig', 'kirigami2', 'kirigami25', 'kjsembed5', 'krita', 'krusader', 'kuserfeedback5', 'kxmlgui5', 'librecad', 'meshroom', 'minuet', 'mixxx', 'mlt-qt', 'mumble', 'nomacs', 'otter-browser', 'q4wine', 'qownnotes', 'qt5-virtualkeyboard', 'qtcurve-qt5', 'quassel', 'rolisteam', 'skrooge', 'sqlitestudio', 'tiled', 'vlc', 'vulkan-lunarg-tools']"
+++
### Description: 

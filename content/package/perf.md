...
size = "2365420"
usize = "12328525"
sha1sum = "7a8d6222580ed474258535edff10689c2c24aeaf"
...
* /usr/bin/trace
* /usr/lib/perf/perf-core/dlfilters/dlfilter-show-cycles.so
* /usr/lib/perf/perf-core/dlfilters/dlfilter-test-api-v0.so
* /usr/lib/perf/perf-core/dlfilters/dlfilter-test-api-v2.so
* /usr/lib/perf/perf-core/perf-archive
* /usr/lib/perf/perf-core/perf-iostat
* /usr/lib/perf/perf-core/scripts/perl/bin/check-perf-trace-record
* /usr/lib/perf/perf-core/scripts/perl/bin/failed-syscalls-record
* /usr/lib/perf/perf-core/scripts/perl/bin/failed-syscalls-report
* /usr/lib/perf/perf-core/scripts/perl/bin/rw-by-file-record
* /usr/lib/perf/perf-core/scripts/perl/bin/rw-by-file-report
* /usr/lib/perf/perf-core/scripts/perl/bin/rw-by-pid-record
* /usr/lib/perf/perf-core/scripts/perl/bin/rw-by-pid-report
* /usr/lib/perf/perf-core/scripts/perl/bin/rwtop-record
* /usr/lib/perf/perf-core/scripts/perl/bin/rwtop-report
* /usr/lib/perf/perf-core/scripts/perl/bin/wakeup-latency-record
* /usr/lib/perf/perf-core/scripts/perl/bin/wakeup-latency-report
* /usr/lib/perf/perf-core/scripts/perl/check-perf-trace.pl
* /usr/lib/perf/perf-core/scripts/perl/failed-syscalls.pl
* /usr/lib/perf/perf-core/scripts/perl/Perf-Trace-Util/lib/Perf/Trace/Context.pm
* /usr/lib/perf/perf-core/scripts/perl/Perf-Trace-Util/lib/Perf/Trace/Core.pm
* /usr/lib/perf/perf-core/scripts/perl/Perf-Trace-Util/lib/Perf/Trace/Util.pm
* /usr/lib/perf/perf-core/scripts/perl/rw-by-file.pl
* /usr/lib/perf/perf-core/scripts/perl/rw-by-pid.pl
* /usr/lib/perf/perf-core/scripts/perl/rwtop.pl
* /usr/lib/perf/perf-core/scripts/perl/wakeup-latency.pl
* /usr/lib/perf/perf-core/scripts/python/arm-cs-trace-disasm.py
* /usr/lib/perf/perf-core/scripts/python/bin/compaction-times-record
* /usr/lib/perf/perf-core/scripts/python/bin/compaction-times-report
* /usr/lib/perf/perf-core/scripts/python/bin/event_analyzing_sample-record
* /usr/lib/perf/perf-core/scripts/python/bin/event_analyzing_sample-report
* /usr/lib/perf/perf-core/scripts/python/bin/export-to-postgresql-record
* /usr/lib/perf/perf-core/scripts/python/bin/export-to-postgresql-report
* /usr/lib/perf/perf-core/scripts/python/bin/export-to-sqlite-record
* /usr/lib/perf/perf-core/scripts/python/bin/export-to-sqlite-report
* /usr/lib/perf/perf-core/scripts/python/bin/failed-syscalls-by-pid-record
* /usr/lib/perf/perf-core/scripts/python/bin/failed-syscalls-by-pid-report
* /usr/lib/perf/perf-core/scripts/python/bin/flamegraph-record
* /usr/lib/perf/perf-core/scripts/python/bin/flamegraph-report
* /usr/lib/perf/perf-core/scripts/python/bin/futex-contention-record
* /usr/lib/perf/perf-core/scripts/python/bin/futex-contention-report
* /usr/lib/perf/perf-core/scripts/python/bin/gecko-record
* /usr/lib/perf/perf-core/scripts/python/bin/gecko-report
* /usr/lib/perf/perf-core/scripts/python/bin/intel-pt-events-record
* /usr/lib/perf/perf-core/scripts/python/bin/intel-pt-events-report
* /usr/lib/perf/perf-core/scripts/python/bin/mem-phys-addr-record
* /usr/lib/perf/perf-core/scripts/python/bin/mem-phys-addr-report
* /usr/lib/perf/perf-core/scripts/python/bin/netdev-times-record
* /usr/lib/perf/perf-core/scripts/python/bin/netdev-times-report
* /usr/lib/perf/perf-core/scripts/python/bin/net_dropmonitor-record
* /usr/lib/perf/perf-core/scripts/python/bin/net_dropmonitor-report
* /usr/lib/perf/perf-core/scripts/python/bin/powerpc-hcalls-record
* /usr/lib/perf/perf-core/scripts/python/bin/powerpc-hcalls-report
* /usr/lib/perf/perf-core/scripts/python/bin/sched-migration-record
* /usr/lib/perf/perf-core/scripts/python/bin/sched-migration-report
* /usr/lib/perf/perf-core/scripts/python/bin/sctop-record
* /usr/lib/perf/perf-core/scripts/python/bin/sctop-report
* /usr/lib/perf/perf-core/scripts/python/bin/stackcollapse-record
* /usr/lib/perf/perf-core/scripts/python/bin/stackcollapse-report
* /usr/lib/perf/perf-core/scripts/python/bin/syscall-counts-by-pid-record
* /usr/lib/perf/perf-core/scripts/python/bin/syscall-counts-by-pid-report
* /usr/lib/perf/perf-core/scripts/python/bin/syscall-counts-record
* /usr/lib/perf/perf-core/scripts/python/bin/syscall-counts-report
* /usr/lib/perf/perf-core/scripts/python/bin/task-analyzer-record
* /usr/lib/perf/perf-core/scripts/python/bin/task-analyzer-report
* /usr/lib/perf/perf-core/scripts/python/check-perf-trace.py
* /usr/lib/perf/perf-core/scripts/python/compaction-times.py
* /usr/lib/perf/perf-core/scripts/python/event_analyzing_sample.py
* /usr/lib/perf/perf-core/scripts/python/export-to-postgresql.py
* /usr/lib/perf/perf-core/scripts/python/export-to-sqlite.py
* /usr/lib/perf/perf-core/scripts/python/exported-sql-viewer.py
* /usr/lib/perf/perf-core/scripts/python/failed-syscalls-by-pid.py
* /usr/lib/perf/perf-core/scripts/python/flamegraph.py
* /usr/lib/perf/perf-core/scripts/python/futex-contention.py
* /usr/lib/perf/perf-core/scripts/python/gecko.py
* /usr/lib/perf/perf-core/scripts/python/intel-pt-events.py
* /usr/lib/perf/perf-core/scripts/python/libxed.py
...
* /usr/lib/perf/perf-core/scripts/python/Perf-Trace-Util/lib/Perf/Trace/Util.py
* /usr/lib/perf/perf-core/scripts/python/powerpc-hcalls.py
* /usr/lib/perf/perf-core/scripts/python/sched-migration.py
* /usr/lib/perf/perf-core/scripts/python/sctop.py
* /usr/lib/perf/perf-core/scripts/python/stackcollapse.py
* /usr/lib/perf/perf-core/scripts/python/stat-cpi.py
...
* /usr/lib/perf/perf-core/tests/shell/common/check_errors_whitelisted.pl
...
* /usr/lib/perf/perf-core/tests/shell/perftool-testsuite_report.sh
...
* /usr/lib/perf/perf-core/tests/shell/record+script_probe_vfs_getname.sh
* /usr/lib/perf/perf-core/tests/shell/record+zstd_comp_decomp.sh
* /usr/lib/perf/perf-core/tests/shell/record.sh
* /usr/lib/perf/perf-core/tests/shell/record_bpf_filter.sh
* /usr/lib/perf/perf-core/tests/shell/record_lbr.sh
* /usr/lib/perf/perf-core/tests/shell/record_offcpu.sh
* /usr/lib/perf/perf-core/tests/shell/record_sideband.sh
* /usr/lib/perf/perf-core/tests/shell/script.sh
* /usr/lib/perf/perf-core/tests/shell/stat+csv_output.sh
* /usr/lib/perf/perf-core/tests/shell/stat+csv_summary.sh
* /usr/lib/perf/perf-core/tests/shell/stat+json_output.sh
* /usr/lib/perf/perf-core/tests/shell/stat+shadow_stat.sh
* /usr/lib/perf/perf-core/tests/shell/stat+std_output.sh
* /usr/lib/perf/perf-core/tests/shell/stat.sh
* /usr/lib/perf/perf-core/tests/shell/stat_all_metricgroups.sh
* /usr/lib/perf/perf-core/tests/shell/stat_all_metrics.sh
* /usr/lib/perf/perf-core/tests/shell/stat_all_pfm.sh
* /usr/lib/perf/perf-core/tests/shell/stat_all_pmu.sh
* /usr/lib/perf/perf-core/tests/shell/stat_bpf_counters.sh
* /usr/lib/perf/perf-core/tests/shell/stat_bpf_counters_cgrp.sh
...
* /usr/lib/perf/perf-core/tests/shell/test_data_symbol.sh
* /usr/lib/perf/perf-core/tests/shell/test_intel_pt.sh
* /usr/lib/perf/perf-core/tests/shell/test_java_symbol.sh
* /usr/lib/perf/perf-core/tests/shell/test_perf_data_converter_json.sh
* /usr/lib/perf/perf-core/tests/shell/test_stat_intel_tpebs.sh
* /usr/lib/perf/perf-core/tests/shell/test_task_analyzer.sh

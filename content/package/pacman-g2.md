...
size = "3102640"
usize = "8137499"
sha1sum = "2929f2abace99142bf8eb94678b7a245505b3398"
...
+++
A .tar.xz based package manager library (libpacman) and client (pacman-g2) with dependency support.{{< spoiler text="show files" >}}* /etc/bash_completion.d/pacman-g2

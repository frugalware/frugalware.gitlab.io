...
version = "0.41-1"
description = "glib objects for spice protocol decoding and surface rendering"
...
+++
glib objects for spice protocol decoding and surface rendering{{< spoiler text="show files" >}}* /usr/include/spice-client-glib-2.0/channel-cursor.h
...
* /usr/lib/libspice-client-glib-2.0.so.8.8.1

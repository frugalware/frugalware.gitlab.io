...
version = "0.4.2-8"
description = "VDPAU backend which converts VDPAU calls to OpenGL and VAAPI."
...
+++
VDPAU backend which converts VDPAU calls to OpenGL and VAAPI.{{< spoiler text="show files" >}}* /usr/lib/vdpau/libvdpau_va_gl.so

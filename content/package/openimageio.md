...
+++
A library for reading and writing images, including classes, utilities, and applications.{{< spoiler text="show files" >}}* /usr/bin/iconvert
* /usr/bin/idiff
* /usr/bin/igrep
* /usr/bin/iinfo
* /usr/bin/iv

...
+++
Vala is a prgramming language that aims to bring modern programming language features to GNOME developers{{< spoiler text="show files" >}}* /usr/bin/vala
* /usr/bin/vala-0.56
...
* /usr/share/man/man1/valadoc-0.56.1.gz

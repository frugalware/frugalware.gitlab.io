...
+++
An interface to the SANE scanner and frame grabber interface for Linux.{{< files text="show files" >}}* /usr/lib/python3.12/site-packages/python_sane-2.9.1-py3.12.egg-info/dependency_links.txt

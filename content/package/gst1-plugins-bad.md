+++
draft = false
title = "gst1-plugins-bad 1.24.2-1"
version = "1.24.2-1"
...
size = "2910032"
usize = "13244043"
sha1sum = "1c8c9168fe66307b9322594c27321abf9fd61aa8"
depends = "['gst1-plugins-base>=1.24.2', 'ldacbt', 'libass>=0.13.6', 'libffi>=3.2.1-2', 'libfreeaptx', 'libgudev>=230-7', 'libjpeg-turbo', 'libpng>=1.6.27', 'libsoup', 'libwpe', 'lilv', 'mjpegtools>=2.2.1', 'nettle>=3.6', 'nice', 'openjpeg>=2.2.0', 'openssl>=3.1.0', 'pango', 'x265>=3.5']"

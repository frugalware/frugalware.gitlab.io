...
depends = "['glibc']"
+++
QuantStack tools library - Multi-dimensional arrays with broadcasting and lazy computing{{< spoiler text="show files" >}}* /usr/include/xsimd/arch/generic/xsimd_generic_arithmetic.hpp

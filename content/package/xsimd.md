...
depends = "['glibc']"
+++
QuantStack tools library - Multi-dimensional arrays with broadcasting and lazy computing{{< files text="show files" >}}* /usr/include/xsimd/arch/generic/xsimd_generic_arithmetic.hpp

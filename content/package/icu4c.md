...
reverse_depends = "['blender', 'calamares-frugalware', 'calibre', 'chromium-browser', 'darktable', 'dovecot', 'firebird', 'firefox', 'freeciv', 'freerdp', 'grpc', 'gspell', 'harfbuzz-icu', 'harfbuzz-utils', 'kdeplasma-addons', 'kdeplasma-addons5', 'libboost', 'libcdr', 'libe-book', 'libical', 'liblcf', 'libmspub', 'libqalculate', 'libsmbclient', 'libvisio', 'libxml2', 'libzmf', 'mpd', 'ncmpcpp', 'netpbm', 'nodejs', 'nodejs18', 'openttd', 'poedit', 'postfix', 'postgresql', 'qt5-base', 'qt5-location', 'qt5-webengine', 'qt6-5compat', 'qt6-base', 'qt6-webengine', 'r', 're2', 'rspamd', 'scribus', 'texlive', 'thunderbird', 'user-kcm', 'vte3', 'xerces-c', 'xfsprogs', 'znc']"
license = "License"
+++
### Description: 
...
* /usr/share/man/man1/icuexportdata.1.gz

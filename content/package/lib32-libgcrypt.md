...
+++
Libgcrypt is a general purpose cryptographic library based on the code from GnuPG. ( 32bit ){{< spoiler text="show files" >}}* /usr/i686-frugalware-linux/bin/dumpsexp

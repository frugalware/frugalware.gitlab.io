...
reverse_depends = "['chromium-browser', 'efl', 'enlightenment', 'freerdp', 'freerdp2', 'glfw', 'gst1-plugins-bad-vulkan', 'gtk+3', 'gtk+4', 'i3', 'i3lock', 'kitty', 'libwpe', 'mangohud', 'obs-studio', 'qt5-base', 'qt6-base', 'terminology', 'weston', 'wine', 'wine-devel', 'wlroots', 'xdotool']"
+++
### Description: 

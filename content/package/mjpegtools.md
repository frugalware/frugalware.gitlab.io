...
size = "738188"
usize = "2445903"
sha1sum = "19cb71d8805e706f3e8a15288242063f0d08a632"
...
+++
The mjpeg programs are a set of tools that can do recording of videos and playback under Linux.{{< spoiler text="show files" >}}* /usr/bin/anytovcd.sh
* /usr/bin/jpeg2yuv
* /usr/bin/lav2avi.sh
* /usr/bin/lav2mpeg
* /usr/bin/lav2wav
...
* /usr/lib/liblavplay-2.2.so.0
* /usr/lib/liblavplay-2.2.so.0.0.0

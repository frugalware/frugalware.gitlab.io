...
+++
Libsndfile is a C library for reading and writing files containing sampled sound{{< spoiler text="show files" >}}* /usr/bin/sndfile-cmp
...
* /usr/share/doc/libsndfile-1.0.28/INSTALL

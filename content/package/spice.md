...
version = "0.15.1-2"
description = "Implements the SPICE protocol"
...
+++
Implements the SPICE protocol{{< spoiler text="show files" >}}* /usr/include/spice-server/spice-audio.h
...
* /usr/lib/libspice-server.so.1.14.2

...
+++
A userspace library providing interface to packets that have been logged by the kernel packet filter.{{< spoiler text="show files" >}}* /usr/include/libnetfilter_log/libipulog.h
...
* /usr/lib/libnetfilter_log.so.1.2.0

...
+++
This plugin scans all messages that are received from an IMAP, LOCAL or POP account using clamd (Clam AV).{{< spoiler text="show files" >}}* /usr/lib/claws-mail/plugins/clamd.so
{{< /spoiler >}}
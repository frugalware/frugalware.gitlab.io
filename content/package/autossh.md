...
depends = "['openssh']"
+++
autossh is a program to start a copy of ssh and monitor it, restarting it as necessary should it die or stop passing traffic{{< files text="show files" >}}* /usr/bin/autossh

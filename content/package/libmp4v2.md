...
+++
A library for working with files using the mp4 container format. (extracted from mpeg4ip).{{< spoiler text="show files" >}}* /usr/bin/mp4art
* /usr/bin/mp4chaps
* /usr/bin/mp4extract
* /usr/bin/mp4file
* /usr/bin/mp4info
...
* /usr/share/doc/libmp4v2-5.0.1/COPYING
* /usr/share/doc/libmp4v2-5.0.1/INSTALL
* /usr/share/doc/libmp4v2-5.0.1/README.md

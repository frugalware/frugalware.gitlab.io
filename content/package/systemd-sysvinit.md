...
reverse depends = "['systemd']"
files = "['/usr/bin/halt', '/usr/bin/init', '/usr/bin/poweroff', '/usr/bin/reboot', '/usr/bin/runlevel', '/usr/bin/shutdown', '/usr/bin/telinit', '/usr/share/man/man8/halt.8.gz', '/usr/share/man/man8/poweroff.8.gz', '/usr/share/man/man8/reboot.8.gz', '/usr/share/man/man8/runlevel.8.gz', '/usr/share/man/man8/shutdown.8.gz', '/usr/share/man/man8/telinit.8.gz']"
+++

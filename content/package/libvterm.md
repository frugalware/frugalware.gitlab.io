...
files = "['/usr/bin/unterm', '/usr/bin/vterm-ctrl', '/usr/bin/vterm-dump', '/usr/include/vterm.h', '/usr/include/vterm_keycodes.h', '/usr/lib/libvterm.so', '/usr/lib/libvterm.so.0', '/usr/lib/libvterm.so.0.0.0', '/usr/lib/pkgconfig/vterm.pc', '/usr/share/doc/libvterm-0.3.2/LICENSE']"
+++

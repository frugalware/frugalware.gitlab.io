...
depends = "['alsa-lib', 'bluez', 'curl', 'cyrus-sasl', 'dtc', 'fuse3', 'jemalloc', 'libaio', 'libbpf', 'libepoxy', 'libgbm', 'libgl', 'libglu', 'libjpeg-turbo', 'libpng>=1.6.20', 'libseccomp', 'libssh2', 'libsysprof-capture', 'liburing', 'libx11', 'lzo', 'ncurses>=6.0-3', 'nettle>=3.6', 'nss', 'numactl', 'pipewire', 'pixman', 'pulseaudio', 'sdl2', 'snappy', 'spice-protocol', 'usbredir>=0.8.0', 'vte3', 'xkeyboard-config']"
...
* /usr/share/doc/qemu-9.2.0/COPYING
* /usr/share/doc/qemu-9.2.0/COPYING.LIB
* /usr/share/doc/qemu-9.2.0/LICENSE
* /usr/share/doc/qemu-9.2.0/README.Frugalware
* /usr/share/doc/qemu-9.2.0/README.rst
* /usr/share/doc/qemu-9.2.0/VERSION

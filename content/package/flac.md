...
reverse_depends = "['audiocd-kio', 'chromium-browser', 'efl', 'enlightenment', 'gst1-plugins-good-flac', 'k3b', 'kwave', 'libopenmpt', 'libsndfile', 'minidlna', 'mixxx', 'mkvtoolnix', 'mpd', 'qmmp', 'rubberband', 'scummvm', 'scummvm-tools', 'sdlmame', 'sfml', 'sox', 'terminology', 'twolame', 'vlc-flac', 'vorbis-tools', 'xine-lib']"
+++
### Description: 

...
size = "1115416"
usize = "5378221"
sha1sum = "f7a602d7f70a49e336587d8e4c5908d378d333c1"
depends = "['dbus', 'dbus-glib', 'gtk+2-libs>=2.24.31-2', 'iso-codes', 'libcanberra', 'libnotify>=0.7.7', 'libproxy>=0.5.7', 'openssl>=3.1.0', 'pciutils>=3.4.1', 'perl>=5.22.1', 'python3>=3.13']"
+++
### Description: 
...
* /usr/lib/hexchat/python/hexchat.py
* /usr/lib/hexchat/python/xchat.py
* /usr/lib/hexchat/python/_hexchat.py

...
reverse_depends = "['dracut', 'hwdata', 'intel-gpu-tools', 'kernel', 'kernel-initrd', 'kernel-lts', 'kernel-lts-initrd', 'systemd', 'systemd-nspawn', 'systemd-systemctl', 'systemd-sysvinit']"
+++
### Description: 

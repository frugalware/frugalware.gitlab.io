...
title = "pigz 2.7-1"
version = "2.7-1"
description = "A gzip implementation that can use parallel threads."
date = "2022-12-13T08:58:26"
aliases = "/packages/135978"
...
depends = "['zlib>=1.2.12']"
+++
A gzip implementation that can use parallel threads.{{< spoiler text="show files" >}}* /usr/bin/pigz
* /usr/bin/unpigz

...
reverse_depends = "['argyllcms', 'box2d', 'cef', 'clightd', 'colord-kde', 'ddcutil', 'efl', 'enlightenment', 'fluxbox', 'fox', 'fox-1.2', 'freerdp', 'freerdp2', 'geogram', 'gtk+2-libs', 'gtk+3', 'gtk+4', 'gtkmm', 'gtkmm3', 'intel-gpu-tools', 'ksubeditor', 'ksubtile', 'libcec', 'libkscreen', 'libreoffice', 'libxpresent', 'lsp-plugins', 'mpv', 'mupdf', 'ogre', 'opendiablo2', 'openscenegraph', 'openxr', 'qt5-webengine', 'qt6-multimedia', 'qt6-webengine', 'setxkbmap', 'sfml', 'spice-vdagent', 'stepmania', 'supertuxkart', 'telegram-desktop', 'terminology', 'virtualbox', 'virtualbox-guest-additions', 'whalebird', 'wine', 'wine-devel', 'xev', 'xf86-input-wacom', 'xf86-video-intel', 'xinput', 'xrandr', 'xrdp']"
license = "GPL2"
+++
### Description: 
X RandR Library
...
* /usr/share/doc/libxrandr-1.5.4/AUTHORS
* /usr/share/doc/libxrandr-1.5.4/ChangeLog
* /usr/share/doc/libxrandr-1.5.4/COPYING
* /usr/share/doc/libxrandr-1.5.4/INSTALL
* /usr/share/doc/libxrandr-1.5.4/README.md

...
reverse_depends = "['alienarena', 'allegro', 'assaultcube', 'cdrdao', 'efl', 'enlightenment', 'ffmpeg', 'ffmpeg4.4', 'freeorion', 'gst1-plugins-base-vorbis', 'icecast', 'ices', 'libcanberra', 'libextractor', 'libmp3splt', 'libpulse', 'libshout', 'libsndfile', 'love', 'megaglest', 'minidlna', 'mkvtoolnix', 'mlt', 'naev', 'scummvm-tools', 'sdl2_mixer', 'solarus', 'stepmania', 'supertux', 'supertuxkart', 'terminology', 'vlc-vorbis', 'vorbis-tools', 'vorbisgain', 'xonotic']"
+++
### Description: 

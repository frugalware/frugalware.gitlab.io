...
+++
Light/dark theme switcher for Linux. Supports popular Desktops, text editors and more!{{< spoiler text="show files" >}}* /opt/yin-yang/designer/main_window.ui
...
* /opt/yin-yang/resources/translations/yin_yang.de_DE.qm
...
* /opt/yin-yang/resources/yin_yang.service
* /opt/yin-yang/resources/yin_yang.timer
* /opt/yin-yang/scripts/build_ui.sh
* /opt/yin-yang/scripts/install.sh
* /opt/yin-yang/scripts/uninstall.sh
* /opt/yin-yang/tests/test_communication.py
* /opt/yin-yang/tests/test_config.py
* /opt/yin-yang/tests/test_daemon.py
* /opt/yin-yang/tests/test_daemon_handler.py
* /opt/yin-yang/tests/test_plugins.py
* /opt/yin-yang/tests/test_plugin_class.py
* /opt/yin-yang/tests/__init__.py
* /opt/yin-yang/yin_yang/communicate.py
* /opt/yin-yang/yin_yang/config.py
...
* /opt/yin-yang/yin_yang/plugins/kvantum.py
...
* /opt/yin-yang/yin_yang/ui/resources_rc.py
* /opt/yin-yang/yin_yang/ui/__init__.py
* /opt/yin-yang/yin_yang/__init__.py
* /opt/yin-yang/yin_yang/__main__.py
* /usr/bin/yin-yang

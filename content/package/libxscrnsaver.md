...
reverse_depends = "['beforelight', 'cef', 'chromium-browser', 'discord', 'dunst', 'efl', 'enlightenment', 'kaffeine', 'kidletime', 'kidletime5', 'kvirc', 'mpv', 'pidgin', 'qt5-webengine', 'quba', 'r2modman', 'retroshare', 'signal-desktop', 'sim', 'slack-desktop', 'teams-for-linux', 'terminology', 'tk', 'xf86-video-intel', 'xine-ui']"
license = "GPL2"
+++
### Description: 

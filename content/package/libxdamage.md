...
reverse_depends = "['conky', 'distcc-gui', 'efl', 'enlightenment', 'firefox', 'freeciv', 'freerdp', 'freerdp2', 'gst1-plugins-good-ximage', 'gtk+2-libs', 'gtk2-sharp', 'gtk3-sharp', 'guvcview', 'hot-babe', 'kompose', 'ksubeditor', 'ksubtile', 'libepoxy', 'libextractor', 'libgl', 'maxemumtvguide', 'printoxx', 'terminology', 'virtualbox-guest-additions', 'whalebird', 'xcfa', 'xf86-video-intel', 'xpad']"
license = "GPL2"
+++
### Description: 

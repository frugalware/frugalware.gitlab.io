...
depends = "['glibc>=2.34']"
reverse_depends = "['aircrack-ng', 'criu', 'hostapd', 'i3status', 'iw', 'libksysguard', 'libvirt', 'networkmanager', 'nfs-utils', 'powertop', 'quota-tools', 'rdma-core', 'wavemon', 'wireshark', 'wireshark-qt', 'wpa_supplicant']"
+++
### Description: 

...
+++
Library for handling OpenType fonts (OTF).{{< files text="show files" >}}* /usr/bin/libotf-config
* /usr/bin/otfdump
* /usr/bin/otflist
* /usr/bin/otftobdf
* /usr/include/otf.h
* /usr/lib/libotf.so
* /usr/lib/libotf.so.1
* /usr/lib/libotf.so.1.0.0
* /usr/lib/pkgconfig/libotf.pc
* /usr/share/doc/libotf-0.9.16/AUTHORS
* /usr/share/doc/libotf-0.9.16/ChangeLog
* /usr/share/doc/libotf-0.9.16/COPYING

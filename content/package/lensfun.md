...
+++
Database of photographic lenses and a library that allows advanced access to the database{{< spoiler text="show files" >}}* /usr/bin/g-lensfun-update-data
* /usr/bin/lensfun-add-adapter
* /usr/bin/lensfun-update-data
* /usr/include/lensfun/lensfun.h
* /usr/lib/liblensfun.so
* /usr/lib/liblensfun.so.0.3.2
* /usr/lib/liblensfun.so.1
* /usr/lib/pkgconfig/lensfun.pc
* /usr/share/doc/lensfun-0.3.2/ChangeLog
* /usr/share/doc/lensfun-0.3.2/README.md

...
reverse_depends = "['geoclue2', 'gssdp', 'gvfs', 'libosinfo', 'librest', 'remmina', 'seahorse', 'webkit-gtk3']"
+++
An HTTP library implementation in C{{< spoiler text="show files" >}}* /usr/include/libsoup-3.0/libsoup/soup-auth-domain-basic.h

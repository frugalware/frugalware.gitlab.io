...
reverse_depends = "['c-client', 'cifs-utils', 'cyrus-sasl', 'cyrus-sasl-gssapiv2', 'dante', 'dovecot', 'freerdp', 'freerdp', 'keyutils', 'kio5', 'krb5', 'libreoffice-postgresql', 'libsoup', 'libtirpc', 'loudmouth', 'neon', 'openjre', 'qt6-webengine', 'rsyslog-gssapi', 's-nail', 'samba-client', 'saslauthd', 'wireshark']"
+++
### Description: 

...
title = "love 11.4-1"
version = "11.4-1"
description = "LÃ–VE is a free game engine wich use the LUA programming language"
...
+++
LÃ–VE is a free game engine wich use the LUA programming language{{< spoiler text="show files" >}}* /usr/bin/love

...
version = "1.0.9-1"
description = "A userspace library providing a programming interface to the in-kernel connection tracking state table"
...
+++
A userspace library providing a programming interface to the in-kernel connection tracking state table{{< spoiler text="show files" >}}* /usr/include/libnetfilter_conntrack/libnetfilter_conntrack.h

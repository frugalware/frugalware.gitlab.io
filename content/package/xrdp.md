...
+++
RDP Server - An open source RDP server and X server capable of accepting connections from rdesktop and ms terminal server clients.{{< spoiler text="show files" >}}* /etc/default/xrdp
* /etc/init.d/xrdp

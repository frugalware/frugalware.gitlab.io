...
+++
Enables the scanning of incoming mail received from a POP, IMAP, or LOCAL account using SpamAssassin.{{< spoiler text="show files" >}}* /usr/lib/claws-mail/plugins/spamassassin.so
{{< /spoiler >}}
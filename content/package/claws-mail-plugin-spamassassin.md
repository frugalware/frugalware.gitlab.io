...
+++
Enables the scanning of incoming mail received from a POP, IMAP, or LOCAL account using SpamAssassin.{{< files text="show files" >}}* /usr/lib/claws-mail/plugins/spamassassin.so
{{< /files >}}
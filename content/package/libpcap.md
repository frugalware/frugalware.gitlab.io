...
reverse_depends = "['arpwatch', 'dosbox-x', 'ethereal', 'faifa', 'hyperscan', 'knock', 'ldns', 'nethogs', 'nmap', 'openvas-libraries', 'ppp', 'tcpdump', 'tcpreplay', 'umockdev', 'vde2', 'wavemon', 'wine', 'wine-devel', 'wireshark']"
+++
### Description: 
Library for tcpdump

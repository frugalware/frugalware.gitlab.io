+++
draft = false
title = "lib32-mesa-dri-drivers 25.1.3-1"
version = "25.1.3-1"
...
size = "9150756"
usize = "57831337"
sha1sum = "5ea6f74ade972aac8b4e4a4171116f050a0d7b40"
depends = "['lib32-elfutils>=0.167-3', 'lib32-expat>=2.1.0-6', 'lib32-libdrm>=2.4.71', 'lib32-libffi>=3.2.1-2', 'lib32-libgbm', 'lib32-libunwind', 'lib32-libxshmfence', 'lib32-llvm-libs>=20.1.6', 'lib32-lmsensors>=3.5.0', 'lib32-spirv-tools', 'lib32-zstd']"
...
### Files: 
* /usr/i686-frugalware-linux/include/gbm_backend_abi.h
...
* /usr/lib32/libgallium-25.1.3.so

...
+++
Lightweight speech recognition engine, specifically tuned for handheld and mobile devices, though it works equally well on the desktop{{< files text="show files" >}}* /usr/bin/pocketsphinx_batch

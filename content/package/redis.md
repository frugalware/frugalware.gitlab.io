...
+++
Redis is an open source in-memory data structure store{{< spoiler text="show files" >}}* /etc/logrotate.d/redis
...
* /usr/share/doc/redis-7.2.4/00-RELEASENOTES
* /usr/share/doc/redis-7.2.4/BUGS

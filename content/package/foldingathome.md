...
files = "['/opt/fah/FAHClient', '/opt/fah/FAHCoreWrapper', '/opt/fah/sample-config.xml', '/usr/lib/systemd/system/foldingathome.service', '/usr/share/doc/foldingathome-7.6.21/README.md']"
+++

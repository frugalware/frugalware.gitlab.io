...
+++
A CSS parser and selection engine library, written in C.{{< spoiler text="show files" >}}* /usr/include/libcss/computed.h
...
* /usr/include/libcss/unit.h
* /usr/lib/libcss.so
* /usr/lib/libcss.so.0
* /usr/lib/libcss.so.0.9.2

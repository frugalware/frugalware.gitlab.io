...
license = "GPL"
+++
kernel module that enables calls to ACPI methods through /proc/acpi/call{{< spoiler text="show files" >}}* /usr/lib/modules/6.7.6-fw1/kernel/drivers/acpi/acpi_call.ko.zst

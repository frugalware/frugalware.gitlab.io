...
depends = "['firefox>=1.5']"
+++
allows you to switch between tabs with customized shortcuts. Default are Ctrl+Left/Right{{< spoiler text="show files" >}}* usr/lib/firefox/extensions/{7AFBDE9F-DFC7-4528-913A-CE8BCAA6EA0E}/chrome.manifest

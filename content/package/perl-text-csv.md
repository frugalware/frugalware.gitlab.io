...
depends = "['perl>=5.34.0']"
+++
Text::CSV provides facilities for the composition and decomposition of comma-separated values{{< files text="show files" >}}* /usr/lib/perl5/site_perl/Text/CSV.pm

...
+++
Provides a core library and set of utilities for the creation and parsing of messages using MIME{{< spoiler text="show files" >}}* /usr/include/gmime-2.6/gmime/gmime-certificate.h

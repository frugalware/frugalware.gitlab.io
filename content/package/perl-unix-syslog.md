...
+++
Perl interface to the UNIX syslog(3) calls{{< spoiler text="show files" >}}* /usr/lib/perl5/site_perl/current/x86_64-linux-thread-multi/auto/Unix/Syslog/Syslog.so

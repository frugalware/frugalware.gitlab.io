...
+++
Collection of libraries and utilities for working with ELF object files and DWARF debugging information ( 32bit ){{< files text="show files" >}}* /usr/i686-frugalware-linux/bin/eu-addr2line

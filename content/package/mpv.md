...
+++
A movie player based on mplayer and mplayer2. It supports a wide variety of video file formats, audio and video codecs, and subtitle types.{{< files text="show files" >}}* /etc/mpv/encoding-profiles.conf
* /usr/bin/mpv

...
+++
Enables the scanning of incoming mail received from a POP, IMAP, or LOCAL account using Bogofilter.{{< files text="show files" >}}* /usr/lib/claws-mail/plugins/bogofilter.so
{{< /files >}}
...
size = "11428500"
usize = "34748930"
sha1sum = "6e3623f9d3feaaae33b9df13f1525df74f859e27"
depends = "['cdrdao>=1.2.3-6', 'cdrtools>=3.01-3', 'dvd+rw-tools>=7.1-4', 'ffmpeg>=7.0', 'kcmutils5>=5.116.0', 'kfilemetadata5>=5.116.0', 'knewstuff5>=5.116.0', 'knotifyconfig5>=5.116.0', 'libdvdread>=6.1.1', 'libkcddb5>=24.05.2', 'libmpcdec>=1.2.6-4', 'libsamplerate>=0.1.9', 'qt5-svg>=5.15.14libmad>=0.15.1b-9']"
+++
### Description: 
The CD Kreator
...
* /usr/share/doc/k3b-24.05.2/ChangeLog
* /usr/share/doc/k3b-24.05.2/FAQ.txt
* /usr/share/doc/k3b-24.05.2/INSTALL.txt
* /usr/share/doc/k3b-24.05.2/README.txt

...
+++
An audio processing plugin system for plugins that extract descriptive information from audio data{{< files text="show files" >}}* /usr/bin/vamp-rdf-template-generator

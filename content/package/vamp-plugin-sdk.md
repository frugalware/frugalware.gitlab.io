...
version = "2.2.1-5"
description = "An audio processing plugin system for plugins that extract descriptive information from audio data"
...
+++
An audio processing plugin system for plugins that extract descriptive information from audio data{{< spoiler text="show files" >}}* /usr/bin/vamp-rdf-template-generator
...
* /usr/lib/libvamp-hostsdk.so.3.2.0
* /usr/lib/libvamp-sdk.so
* /usr/lib/libvamp-sdk.so.2
* /usr/lib/libvamp-sdk.so.2.2.0
...
* /usr/share/doc/vamp-plugin-sdk-2.2.1/CHANGELOG
* /usr/share/doc/vamp-plugin-sdk-2.2.1/COPYING

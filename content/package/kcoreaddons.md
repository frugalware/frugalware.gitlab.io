...
+++
Utilities for core application functionality and accessing the OS.{{< spoiler text="show files" >}}* /usr/bin/desktoptojson
...
* /usr/share/doc/kcoreaddons-5.115.0/README.md

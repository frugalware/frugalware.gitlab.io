...
reverse_depends = "['alligator', 'audiotube', 'breeze', 'calamares-frugalware', 'discover', 'disman', 'dolphin', 'itinerary', 'kalk', 'kauth', 'kcachegrind', 'kclock', 'kconfigwidgets', 'kcontacts', 'kcrash', 'kdav', 'kdav2', 'kdebugsettings', 'kdecoration', 'kdeplasma-addons', 'kdeplasma-addons5', 'kdesignerplugin', 'kdiff3', 'kfilemetadata', 'kglobalacceld', 'kimap2', 'kjournald', 'kongress', 'kontrast', 'kopete', 'kpackage', 'kpimtextedit', 'kpipewire', 'kpty', 'krecorder', 'ksmtp', 'ksvg', 'ktrip', 'ktux', 'kwin', 'libkcompactdisc', 'libreoffice-gtk3-kde5', 'libreoffice-kde5', 'plasma-sdk', 'plasma5support', 'plasmatube', 'purpose', 'qmlkonsole', 'rkward', 'svgpart', 'sweeper']"
+++
### Description: 

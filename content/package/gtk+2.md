...
reverse_depends = "['dunst', 'emacs', 'ethereal', 'firefox', 'freeciv-gtk2', 'gfpm', 'gftp', 'gnokii-gui', 'gnome-clipboard-daemon', 'gtans', 'gtk+2-demos', 'gtk+2-engines-clearlooks', 'gtk-lshw', 'gtk2-sharp', 'gtkspell', 'gvidcap', 'gxmame', 'hot-babe', 'libcanberra-gtk2', 'libextractor', 'libwnck2', 'mozilla', 'openssh-askpass', 'oxygen-gtk', 'parcellite', 'pidgin', 'pinentry-gtk+2', 'pioneers', 'printoxx', 'qtcurve-gtk', 'scim', 'thunderbird', 'xsane', 'xscreensaver']"
+++
### Description: 

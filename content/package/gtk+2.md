...
reverse_depends = "['calf', 'dunst', 'emacs', 'ethereal', 'firefox', 'gfpm', 'gftp', 'gnokii-gui', 'gnome-clipboard-daemon', 'gtans', 'gtk+2-demos', 'gtk+2-engines-clearlooks', 'gtk2-sharp', 'gtkspell', 'gvidcap', 'gxmame', 'hot-babe', 'libcanberra-gtk2', 'libextractor', 'libwnck2', 'mozilla', 'openssh-askpass', 'oxygen-gtk', 'parcellite', 'pidgin', 'pinentry-gtk+2', 'pioneers', 'printoxx', 'qtcurve-gtk', 'scim', 'thunderbird', 'xsane', 'xscreensaver']"
+++
### Description: 

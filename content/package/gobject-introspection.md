...
+++
Generate interface introspection data for GObject libraries.{{< spoiler text="show files" >}}* /usr/bin/g-ir-annotation-tool
...
* /usr/lib/gobject-introspection/giscanner/doctemplates/devdocs/meson.build
...
* /usr/lib/gobject-introspection/giscanner/doctemplates/mallard/meson.build

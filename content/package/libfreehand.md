...
+++
Libfreehand is library providing ability to interpret and import Adobe/Macromedia drawings into various applications.{{< files text="show files" >}}* /usr/bin/fh2raw
* /usr/bin/fh2svg
* /usr/bin/fh2text

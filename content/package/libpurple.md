...
+++
Library intended to be used by programmers seeking to write an IM client that connects to many IM networks.{{< spoiler text="show files" >}}* /usr/include/libpurple/account.h

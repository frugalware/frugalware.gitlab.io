...
+++
LibTorrent is a BitTorrent library written in C++ for *nix, with a focus on high performance and good code.{{< files text="show files" >}}* /usr/include/torrent/bitfield.h

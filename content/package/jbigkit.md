...
depends = "['glibc>=2.3.4']"
+++
JBIG-KIT implements a highly effective data compression algorithm for bi-level high-resolution images such as fax pages or scanned documents.{{< files text="show files" >}}* /usr/bin/jbgtopbm
* /usr/bin/pbmtojbg
* /usr/include/jbig.h

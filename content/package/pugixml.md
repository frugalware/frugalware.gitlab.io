...
+++
Light-weight, simple and fast XML parser for C++ with XPath support{{< spoiler text="show files" >}}* /etc/ld.so.conf.d/pugixml.conf
...
* /usr/lib/cmake/pugixml/pugixml-targets-release.cmake

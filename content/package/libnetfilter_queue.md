...
+++
A userspace library that provides the programming interface to packets that have been queued by the kernel packet filter.{{< spoiler text="show files" >}}* /usr/include/libnetfilter_queue/libnetfilter_queue.h

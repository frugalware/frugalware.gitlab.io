...
reverse_depends = "['anyremote', 'at-spi2-core', 'cef', 'chromium-browser', 'efl', 'enlightenment', 'keepassxc', 'krfb', 'libfakekey', 'libpulse', 'openjre-x', 'pulseaudio-x11', 'qt5-webengine', 'quba', 'swt', 'teams-for-linux', 'telegram-desktop', 'terminology', 'whalebird', 'x11vnc', 'xautomation', 'xdotool', 'xdpyinfo', 'xf86-video-intel', 'xine-ui']"
license = "GPL2"
+++
### Description: 
X.Org Xtst library

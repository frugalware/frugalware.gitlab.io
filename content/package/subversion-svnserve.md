...
files = "['/etc/sysconfig/svnserve', '/usr/bin/svnserve', '/usr/lib/systemd/system/svnserve.service', '/usr/share/man/man5/svnserve.conf.5.gz', '/usr/share/man/man8/svnserve.8.gz']"
+++

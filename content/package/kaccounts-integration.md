...
+++
Small system to administer web accounts like: Google, Facebook, Owncloud, IMAP, Jabber and others{{< spoiler text="show files" >}}* /usr/include/KAccounts/AccountServiceToggleJob

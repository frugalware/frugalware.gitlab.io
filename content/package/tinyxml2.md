...
+++
A simple, small, C++ XML parser that can be easily integrated into other programs.{{< spoiler text="show files" >}}* /usr/include/tinyxml2.h
...
* /usr/lib/libtinyxml2.so.9
* /usr/lib/libtinyxml2.so.9.0.0

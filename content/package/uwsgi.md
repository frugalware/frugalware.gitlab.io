...
size = "449060"
usize = "1854987"
sha1sum = "881c3a2c47ef538d16af9ab8cef030647c22c11f"
depends = "['jansson', 'libcap', 'libuuid', 'libxml2', 'mono', 'openssl>=3.1.0', 'pcre', 'zeromq']"
...
license = "GPL2"
+++
A fast, self-healing and developer/sysadmin-friendly application container server coded in pure C{{< spoiler text="show files" >}}* /etc/tmpfiles.d/uwsgi.conf
* /usr/bin/uwsgi
...
* /usr/lib/uwsgi/dummy_plugin.so
* /usr/lib/uwsgi/echo_plugin.so
* /usr/lib/uwsgi/emperor_amqp_plugin.so
* /usr/lib/uwsgi/emperor_zeromq_plugin.so
* /usr/lib/uwsgi/example_plugin.so
* /usr/lib/uwsgi/exception_log_plugin.so
* /usr/lib/uwsgi/fiber_plugin.so
* /usr/lib/uwsgi/greenlet_plugin.so
...
* /usr/lib/uwsgi/pypy_plugin.so
* /usr/lib/uwsgi/rbthreads_plugin.so

+++
draft = false
title = "firefox 139.0.4-2"
version = "139.0.4-2"
description = "Mozilla Firefox web browser"
date = "2025-06-16T11:26:06"
...
size = "79890304"
usize = "294136176"
sha1sum = "2240baf3767a12246fc70c56adca841e79ec5991"
depends = "['alsa-lib', 'aom', 'bzip2', 'cairo', 'curl>=7.50.3-2', 'dav1d>=1.3.0', 'dbus-glib', 'desktop-file-utils', 'ffmpeg>=3.3.2', 'graphite2', 'gtk+2', 'gtk+3>=3.22.4', 'harfbuzz', 'hunspell>=1.6.1', 'libevent>=2.1.11', 'libffi>=3.4', 'libice', 'libidl', 'libnotify', 'libpulse>=9.0-2', 'libstdc++>=6.2.1-5', 'libxau>=1.0.4', 'libxdamage', 'libxdmcp', 'libxft>=2.1.13-2', 'libxt', 'nspr>=4.9.2', 'nss>=3.76', 'sqlite3>=3.25.1-2', 'startup-notification', 'wireless_tools']"

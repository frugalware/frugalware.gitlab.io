+++
draft = false
title = "firefox 134.0.2-1"
version = "134.0.2-1"
description = "Mozilla Firefox web browser"
date = "2025-01-27T09:49:19"
...
size = "67098504"
usize = "248460893"
sha1sum = "065cb8aeb5bab72eba3a3e0a7df9d6a25075753e"
depends = "['alsa-lib', 'aom', 'bzip2', 'cairo', 'curl>=7.50.3-2', 'dav1d>=1.3.0', 'dbus-glib', 'desktop-file-utils', 'ffmpeg>=3.3.2', 'graphite2', 'gtk+2', 'gtk+3>=3.22.4', 'harfbuzz', 'hunspell>=1.6.1', 'icu4c>=76.1', 'jemalloc', 'lcms', 'lcms2', 'libevent>=2.1.11', 'libffi>=3.4', 'libice', 'libidl', 'libnotify', 'libpulse>=9.0-2', 'libstdc++>=6.2.1-5', 'libxau>=1.0.4', 'libxdamage', 'libxdmcp', 'libxft>=2.1.13-2', 'libxt', 'nspr>=4.9.2', 'nss>=3.76', 'sqlite3>=3.25.1-2', 'startup-notification', 'wireless_tools']"
...
* /usr/share/doc/firefox-134.0.2/AUTHORS
* /usr/share/doc/firefox-134.0.2/LICENSE
* /usr/share/doc/firefox-134.0.2/README.txt

...
reverse_depends = "['argyllcms', 'box2d', 'conky', 'dmenu', 'dunst', 'dzen', 'efl', 'enlightenment', 'feh', 'freerdp', 'freerdp2', 'geogram', 'gtk+2-libs', 'gtk+4', 'ksubeditor', 'ksubtile', 'mpv', 'obs-studio', 'opendiablo2', 'openjre-x', 'spice-vdagent', 'terminology', 'virtualbox', 'vlc-skins', 'wine', 'wine-devel', 'xf86-input-wacom', 'xf86-video-intel', 'xine-lib', 'xinput', 'xterm']"
license = "GPL2"
+++
### Description: 

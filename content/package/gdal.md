...
size = "8966324"
usize = "31263805"
sha1sum = "211b6e87dac184496078d3e4a1325c6ddec9caad"
depends = "['expat>=2.1.0-5', 'geos>=3.6.2', 'json-c', 'json-c>=0.14', 'libdeflate', 'libheif', 'libjpeg-turbo', 'libpng>=1.6.20', 'libpq>=11.2-2', 'libxml2>=2.9.4-3', 'openssl>=3.1.0', 'pcre>=1.6.20', 'proj>=9.4.0', 'sqlite3>=3.10.2', 'unixodbc>=2.3.4-2']"
...
* /usr/lib/cmake/gdal/GDAL-targets-release.cmake
* /usr/lib/cmake/gdal/GDAL-targets.cmake
* /usr/lib/cmake/gdal/GDALConfig.cmake
* /usr/lib/cmake/gdal/GDALConfigVersion.cmake
* /usr/lib/gdalplugins/drivers.ini
* /usr/lib/libgdal.so
* /usr/lib/libgdal.so.36
* /usr/lib/libgdal.so.36.3.10.0
...
* /usr/share/doc/gdal-3.10.0/HOWTO-RELEASE
* /usr/share/doc/gdal-3.10.0/README.md
* /usr/share/doc/gdal-3.10.0/VERSION

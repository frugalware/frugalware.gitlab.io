...
author = "VMiklos"
+++
Les développeurs de Frugalware ont le plaisir de vous [annoncer](/news/83) la disponibilité disponibilité de Frugalware 0.8pre2, le deuxième aperçu technique de la prochaine version stable 0.8.  

 Une liste courte et incomplète des changements depuis 0.8pre1:  

* Nouvelles fonctionnalités:
	+ Support de l'excécution de crochet à l'interieur du gestionnaire de paquet - ex. après une mise à jour du systeme réussie.
	+ Ammélioration du support de la liste noire des modules du noyau.
* Paquets mis à jour:
	+ Xfce 4.4.2 - avec des corrections de bugs et des traductions
	+ OpenOffice.org 2.3.1 - avec des corrections de sécurités et de bugs
	+ Tcl et Tk 8.5 - avec le support de polices de caractères anti-aliasés
	+ Octave 3.0.0 - compatibilité avec Matlab est améliorée
	+ Mise à jour des librairies de cryptage - gnutls-2.2 et libgcrypt-1.4
...
[livecd](/download/frugalware-testing-iso/fwlive-0.8pre2-i686-full.iso),
 ...
 [dvd1](/download/frugalware-testing-iso/frugalware-0.8pre2-i686-dvd1.iso) et
